  ...
  <v-container>
    ...
    <div class="main">
      ...
      >
        ...
        <div class="step" data-step-no="9">
          It is important to note that these books are translated in different
          countries and not only the US. Although I initially wanted to focus on
          the US, the number of books was so little that I wanted to look at all
