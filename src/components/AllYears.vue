##read all data
##show pagination
##add yearvue component
##when user clicks on a year, pass data to year view
##year vue renders books and data
##year vue passes info to map view which also renders
<template>
  <v-container>
    <v-row class="mb-4">
